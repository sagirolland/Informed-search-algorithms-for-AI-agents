...
class HaifaEnv(Env):
    """
    The Haifa environment involves crossing the city of Haifa from Start(S) to Goal(G) without falling into any
    construction Holes(H) by walking over the Free(F) spaces along the way.
    ### Action Space
    ...
    ### Arguments
    `desc`: Used to specify a custom map for Haifa. For example,
